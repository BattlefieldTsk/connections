...
if(isset( $_GET['server'] )) {
  ...
  $E_ = mysqli_query($con,"SELECT server_ip FROM player_analytics WHERE server_ip='$IP'");
  if(mysqli_num_rows($E_) < 1) {
    $error = "No information for $IP.";
    header("Location: servers.php?e=".urlencode($error)); exit;
  }
  $name = mysqli_fetch_array($E_);
}
else {
...
<html lang="en">
  <head>
    ...
    <title>Server - Player Analytics</title>
    <!-- Bootstrap core CSS -->
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="pull-right">
              <?php if(isset( $_GET['server'] )) {echo "<form action=\"server.php?server=$IP\" method=\"GET\">";}
                    else{echo "<form action=\"server.php\" method=\"GET\">";} 
              ?>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="panel panel-default">
                ...
                <a href="players.php?server=<?php echo $IP; ?>">
            ...
            <div class="col-md-3 col-sm-6">
              ...
              <div class="panel-body">
                ...
                <a href="sessions.php?server=<?php echo $IP; ?>">
          <div class="panel-footer">
            <div class="row">
            <div class="col-xs-10">
              View Sessions
          ...
          <div class="panel-footer">
            ...
            <div class="col-md-3 col-sm-6">
              ...
              <div class="panel-body">
                ...
                <a href="regions.php?server=<?php echo $IP; ?>">
          <div class="panel-footer">
            <div class="row">
            <div class="col-xs-10">
              View Regions
