...
class MySQLDB
{
   ...
   function MySQLDB(){
      ...
      $this->connection = mysql_connect(PA_DATABASE_SERVER, PA_DATABASE_USER, PA_DATABASE_PASSWORD) or die(mysql_error());
      mysql_select_db(PA_DATABASE_NAME, $this->connection) or die(mysql_error());
